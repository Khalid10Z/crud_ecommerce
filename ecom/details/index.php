...
<div class="cardBox" style="margin-top: -375px;background-color: transparent; z-index: 1;">
            ...
            <h2 id="h2" style="display: block;  margin-left: 80px;margin-top:-100px; " >Les<span > Details commande </span></h2>
            
  

                  
    <div class="container" id="a" >
        <a href="Adddetail.php" class="Btn_add"> <img src="../images/plus.png">Ajouter</a>
  ...
  <thead>
    ...
    <tr >
                <th scope="col">#</th>
                <th scope="col">référance de Produit </th>
                <th scope="col">Quantité de Commandee</th>
  ...
  <?php 
                ...
                $req = mysqli_query($con , "SELECT  commande.numClient , produit.nomProduit ,detailscommande.qteCommandee ,detailscommande.refProduit FROM  detailscommande , produit, commande  WHERE  detailscommande.refProduit=produit.refProduit AND detailscommande.numCommande=commande.numCommande");
                if(mysqli_num_rows($req) == 0){
                    //s'il n'existe pas d'employé dans la base de donné , alors on affiche ce message :
                    echo "Il n'y a pas encore details de commande ajouter !" ;
                    ...
                    while($row=mysqli_fetch_assoc($req)){
                        ...
                        <tr>
                            ...
                            <td><a href="Updatedetail.php?refProduit=<?=$row['refProduit']?>"><img src="../images/pen.png"></a></td>
                            <td><a href="Deletedetail.php?refProduit=<?=$row['refProduit']?>"><img src="../images/trash.png"></a></td>
                        </tr>
    ...
    <div class="cpy_" style="background-color: #171a1c;">
         <p>© 2021 All Rights Reserved By <a href="https://html.design/">Taha iendjaren & khalid Zeroual</a></p>
      </div>
      <!-- jQery -->
