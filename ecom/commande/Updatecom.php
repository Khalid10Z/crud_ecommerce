...
<?php
         ...
         //on récupère le id dans le lien
          ...
          $req = mysqli_query($con , "SELECT * FROM commande WHERE numCommande = $id");
       ...
       if(isset($_POST['button'])){
           ...
           if(isset($numClient)){
               ...
               $req = mysqli_query($con, "UPDATE commande SET numClient = '$numClient' , dateCommande = '$dateCommande'  WHERE numCommande = $id");
    ...
    <div class="form">
        ...
        <h2>Modifier la commande  : <?=$row['numCommande']?> </h2>
        ...
        <form action="" method="POST">
            ...
            <input type="data" name="dateCommande" value="<?=$row['dateCommande']?>">
