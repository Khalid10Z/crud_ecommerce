                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     ...
                     <li class="nav-item">
                        ...
                        <li class="nav-item dropdown" >
                           <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true" > Pages </a>
...
<div class="cardBox" style="margin-top: -375px;background-color: transparent; z-index: 1;">
            ...
            <h2 id="h2" style="display: block;  margin-left: 80px;margin-top:-100px; " >Les<span > Commandes </span></h2>
            
  

                  
    <div class="container" id="a" >
        <a href="Addcom.php" class="Btn_add"> <img src="../images/plus.png">Ajouter</a>
  ...
  <tbody>
            ...
            <?php 
                ...
                $req = mysqli_query($con , "SELECT commande.numCommande , client.nomClient , commande.dateCommande FROM commande, client WHERE commande.numCommande=client.numClient");
                if(mysqli_num_rows($req) == 0){
                    //s'il n'existe pas d'employé dans la base de donné , alors on affiche ce message :
                    echo "Il n'y a pas encore commande ajouter !" ;
                    ...
                    while($row=mysqli_fetch_assoc($req)){
                        ...
                        <tr>
                            ...
                            <td><a href="Updatecom.php?numCommande=<?=$row['numCommande']?>"><img src="../images/pen.png"></a></td>
                            <td><a href="Deletecom.php?numCommande=<?=$row['numCommande']?>"><img src="../images/trash.png"></a></td>
                        </tr>
