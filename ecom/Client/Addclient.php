...
<body>
    <?php
       ...
       if(isset($_POST['button'] )){
           ...
           if(isset($nomClient)){
                ...
                //requête d'ajout
                $req = mysqli_query($con,"INSERT INTO client VALUES(NULL,'$nomClient','$raisonSocial','$adresseClient','$VilleClient','$pays','$telephone')");
                if($req){//si la requête a été effectuée avec succès , on fait une redirection
                    header("location:index.php");
                    $messag="client ajouter";
                }else {//si non
    ...
    <div class="form">
        ...
        <form action="" method="POST">
            ...
            <label>raisonclient</label>
            <input type="text" name="raisonSocial">
            <label>Adresse</label>
            <input type="text" name="adresseClient">
            <label>Ville</label>
            <input type="text" name="VilleClient">
            <label>Pays</label>
            <input type="pays" name="pays">
